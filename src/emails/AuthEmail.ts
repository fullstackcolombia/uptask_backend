...
export class AuthEmail {
  static sendConfirmationEmail = async (user: IEmail) => {
    transporter.sendMail({
      ...
      html: `
        <p>Hola ${user.name}, has creado tu cuenta en UpTask, ya casi está todo listo, solo debes confirmar tu cuentas</p>
  ...
  static sendPasswordResetToken = async (user: IEmail) => {
    transporter.sendMail({
      ...
      html: `
        <p>Hola ${user.name}, has solicitado restablecer la contraseña.</p>
        <p>Visita el siguiente enlace: </p>
